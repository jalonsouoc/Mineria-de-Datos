...
````{r echo=TRUE, message=FALSE, warning=FALSE}
accidentesFinal=subset(accidentes, accidentes$grado_lesividad != "Desconocido", select = c(distrito, tipo_accidente, estado_meteorologico, tipo_vehiculo, tipo_persona, rango_edad, sexo, positiva_alcohol, positiva_droga, grado_lesividad, categoria_lesividad, mes))
