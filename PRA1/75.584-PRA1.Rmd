...
Podemos observar que se concnetran más en el centro en lo que podemos considerar el centro de la Comunidad de Madrid, observando conforme se va saliendo del centro los accidentes van disminuyendo hasta ser bastante escasos.
...
* **distrito:** distrito donde s eproduce el accidente. Con el tenemos localizado y agrupado geográficamente los accidentes.
* **tipo_accidente:** corresponde al tipo de accidente. Relevante en relación a obtener la gravedad de la lesividad del siniestro.
* **estado_meteorologico:** condiciones ambientales que se dan en el momento del siniestro. COmprobaremos si influye finalmente en el grado de lesividadde un accidente, pese a que el estudio previo no es concluyente.
...
* **tio_persona:** tipo de persona vinculada al accidente. Veremos como afecta en la gravedad de un accidente el ser pasajero o conductor por ejemplo.
...
Con todas estas variables, realizaremos el árbold de devisiones, en el cual determinaremos la gravedad de un accidente. Veremos que condiciones son realmente relevantes a la hora de producirse un accidente grave o mortal. Podremos obtener las partes del día, los meses y los distritos que deberán de reforzarse con tal de prevenir accidentes.
