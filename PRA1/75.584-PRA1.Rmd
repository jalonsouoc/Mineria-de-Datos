...
La última discretización que vamos a realizar consistira en obtener el momento del día en el que se produce el accidente en función de la hora, clasificaremos las horas entre Mañana, Tarde, Noche  y Madrugada.
...
````{r echo=TRUE, message=FALSE, warning=FALSE}
plot(accidentes$partes_dia, ain="Accidentes en cada parte del día", xlab="Partes del día", ylab="Cantidad", col="ivory")
````

Podemos observar que en este caso la mayoría de accidentes se produjeron por la tarde en el periodo entre las 12 AM y las 19 PM.
